...
public class NumeroRomanoTest {
    ...
    public void initArrayRegex_test() {
        ...
        assertEquals("(?<!C)[DM]|(?<!X)[LC](?![DM])|(?<!I)[VX](?![LC])|I(?![VX])", numeroRomano.getRegexDiccionario().getValorRegex("grupoSumatorio"));
        assertEquals("(C[DM])|(X[LC])|(I[VX])", numeroRomano.getRegexDiccionario().getValorRegex("grupoSustractivo"));
    }
    ...
    public void toDecimal() {
        ...
        assertTrue(numeroRomano.getRegexDiccionario().getValores().contains("(?<!C)[DM]|(?<!X)[LC](?![DM])|(?<!I)[VX](?![LC])|I(?![VX])"));
        assertTrue(numeroRomano.getRegexDiccionario().getValores().contains("(C[DM])|(X[LC])|(I[VX])"));
    }
    ...
    public void valorDecimal_test() {
        String test = "V";
        numeroRomano.setNumeroRomano(test);
        assertEquals(2, numeroRomano.getRegexDiccionario().getRegexDiccionario().size());
        assertEquals(5, numeroRomano.valorDecimal(test));
